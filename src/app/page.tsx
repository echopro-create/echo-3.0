      ...
      >
        ...
        >
          <div className="mx-auto max-w-3xl text-left md:text-center">
            <h1
              id="hero-title"
              className="text-4xl font-medium leading-[1.15] tracking-[0.005em] text-[color:var(--fg)] md:text-6xl"
            >
        ...
        >
          <div className="mx-auto max-w-3xl">
            ...
            <ol className="mt-8 grid gap-6 md:grid-cols-3">
              <li className="flex h-full flex-col rounded-2xl border border-black/10 p-5">
